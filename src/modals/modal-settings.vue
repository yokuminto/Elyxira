<template>
  <BaseModal :show="show" title="设置" content-class="modal__content--settings" @close="$emit('close')">
    <div class="modal__settings-tabs">
      <button v-if="!hideQuizTab" class="modal__settings-tab" :class="{ 'modal__settings-tab--active': activeTab === 'quiz' }"
    ...
    <div v-if="!hideQuizTab && activeTab === 'quiz'" class="modal__tab-container">
      <!-- 测验设置选项卡内容 -->
